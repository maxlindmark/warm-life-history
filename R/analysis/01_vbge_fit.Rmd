...
```{r M1: All parameters specific by area}
...
```{r M2: L_inf common parameter, t_0 & K specific}
prior2 <-
  prior(normal(-0.5, 1), nlpar = "t0C") +
  prior(normal(-0.5, 1), nlpar = "t0W") +
  prior(normal(0.2, 0.1), nlpar = "KC") +
...
```{r M3: K common parameter, t_0 & L_inf specific}
prior3 <-
  prior(normal(-0.5, 1), nlpar = "t0C") +
  prior(normal(-0.5, 1), nlpar = "t0W") +
  prior(normal(0.2, 0.1), nlpar = "K") +
...
```{r M4: t_0 common parameter, K & L_inf specific}
prior4 <-
  prior(normal(-0.5, 1), nlpar = "t0") +
  prior(normal(0.2, 0.1), nlpar = "KC") +
  prior(normal(0.2, 0.1), nlpar = "KW") +
...
```{r M5: L_inf & K common parameter, t_0 specific}
prior5 <-
  prior(normal(-0.5, 1), nlpar = "t0C") +
  prior(normal(-0.5, 1), nlpar = "t0W") +
  prior(normal(0.2, 0.1), nlpar = "K") +
...
```{r M6: L_inf & t_0 common parameter, K specific}
prior6 <-
  prior(normal(-0.5, 1), nlpar = "t0") +
  prior(normal(0.2, 0.1), nlpar = "KC") +
  prior(normal(0.2, 0.1), nlpar = "KW") +
...
```{r M7: K & t_0 common parameter, L_inf specific}
prior7 <-
  prior(normal(-0.5, 1), nlpar = "t0") +
  prior(normal(0.2, 0.1), nlpar = "K") +
  prior(normal(45, 20), nlpar = "LinfC") +
